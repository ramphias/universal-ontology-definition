...
// L2 Consulting Extension — extends Organization
{ "id": "ConsultingFirm", "label_zh": "咨询公司", "parent": "Organization" }

// L2 Luxury Goods Extension — extends Organization
...
| Two L2 extensions have same class name | Conflict detection at load time, manual arbitration required |
