...
│  └──────────┘  └──────────┘  └──────────┘                          │
├─────────────────────────────────────────────────────────────────────┤
│  L2: 行业与业务领域扩展 (Industry and Domain Extension)                         │
│  ┌──────┐ ┌──────┐ ┌──────┐ ┌──────┐ ┌──────┐                     │
...
// L2 咨询行业与业务领域扩展 — 继承 Organization
{ "id": "ConsultingFirm", "label_zh": "咨询公司", "parent": "Organization" }

// L2 奢侈品行业与业务领域扩展 — 继承 Organization
...
| 两个 L2 Extension 中同名类 | 加载时冲突检测，需人工裁决 |
